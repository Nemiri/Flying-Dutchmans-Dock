CREATE TABLE IF NOT EXISTS dock (
  ...
  max_ships INTEGER UNSIGNED NOT NULL, 
  max_ship_size FLOAT NOT NULL, 
  PRIMARY KEY (id)
);
...
CREATE TABLE IF NOT EXISTS ship (
  ...
  ship_captain VARCHAR(100) NOT NULL, 
  size FLOAT NOT NULL, 
  type VARCHAR(100) NOT NULL, 
  max_tripulation INTEGER NOT NULL, 
...
CREATE TABLE IF NOT EXISTS cargo (
  ...
  risk_class INTEGER UNSIGNED NOT NULL, 
  PRIMARY KEY (id), 
